async function fetchListSubscribeData(subdomain, accessToken) {
    ...
    try {
        console.log('Sending SOAP request for Listsubscribe data...');
        const response = await fetch('/ListsubscribeRequest', {
            method: 'POST',
            headers: {
        ...
        console.error('Error fetching Listsubscribe data:', error);
        throw error;
    }
}