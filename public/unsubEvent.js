async function fetchUnsubEventData(subdomain, accessToken) {
    ...
    try {
        console.log('Sending SOAP request for unsubEvent data...');
        const response = await fetch('/unSubEventRequest', {
            method: 'POST',
            headers: {
        ...
        console.error('Error fetching unsubEvent data:', error);
        throw error;
    }
}